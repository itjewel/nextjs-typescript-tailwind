...
const Row = ({title, movies}: Props) => {
  ...
  <AiOutlineLeft className="absolute top-0 text-[#e1e1e1e2] bottom-0 left-2 z-40 m-auto h-9 w-9 cursor-pointer opacity-0 transition hover:scale-125 group-hover:opacity-100" onClick = {() => handleClick('left')} />
